package com.example.anton.androidlibhomework.model.common;
...
public class NetworkStatus {
    ...
    private static boolean isAirplane() {
        return Settings.Global.getInt(App.getInstance().getContentResolver(), Settings.Global.AIRPLANE_MODE_ON, 0) != 0;
    }
